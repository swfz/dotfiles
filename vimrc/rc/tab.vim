" tab settings
hi TabLineSel  term=bold    cterm=bold,underline ctermfg=219  ctermbg=024   gui=bold,underline
hi TabLineFill term=reverse cterm=reverse,bold   ctermfg=236  ctermbg=075   gui=reverse,bold   guifg=DarkGray guibg=LightGray
hi TabLine     term=reverse cterm=underline      ctermfg=117  ctermbg=236   gui=underline      guifg=white      guibg=DarkGray
